...
from .CAN_original_package.optimizer import  OptimizerCAN
from .CAN_original_package.model import CAN
...
class CAN_original(Models):
    ...
    def train_model(self, **kwargs):
        ...
        model = CAN(hidden1, hidden2, self.num_features, self.num_nodes, features_nonzero, dropout).to(device)
