...
def load_citation(dataset_str="cora", normalization="AugNormAdj", use_feat=True, cuda=True):
    """
    ...
    save_path = 'data/' + dataset_str + '/{}.pkl'.format(dataset_str)
    with open(save_path, 'wb') as f:  # Python 3: open(..., 'wb')
        pkl.dump([edges, values, features_, labels_, idx_train_, idx_val_, idx_test_], f)
...
if __name__ == '__main__':
    ...
    use_feat = True
    adj, features, labels, idx_train, idx_val, idx_test = load_citation_agcr(dataset, normalization, use_feat)
    # adj, features, labels, idx_train, idx_val, idx_test = load_citation(dataset, normalization, use_feat)